...
Engine.prototype.generateSecrets = function(MASTER_SECRET) {
  ...
  secrets.CONTRACT_KEYPAIR_GENERATOR_ec_secp256k1 = crypto.deriveKeypair(MASTER_SECRET, 'CONTRACT_KEYPAIR_GENERATOR_ec_secp256k1', 'secp256k1');

  secrets.MASTER_KEYPAIR_ec_secp256k1 = crypto.deriveKeypair(MASTER_SECRET, 'MASTER_KEYPAIR_ec_secp256k1', 'secp256k1');
