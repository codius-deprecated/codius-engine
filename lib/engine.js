 ...
 *  @param {String} result
 */
Engine.prototype.runContract = function(manifest_hash, opts, callback) {
  var self = this;
  ...
  runner.run(function(){
    // TODO: The stuff below no longer makes sense.
    //
    //       We want to keep contract instances around for a while in case
